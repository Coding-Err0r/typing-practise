...
This project is for typing practise. I did not make this project. I made improvements to the original project. You can find the original project called keykey in github.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/typing-practise.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/typing-practise.git)
